...
- Highcharts je v `web/vendor/highcharts.js`, projektna ikona v glavi je neposredno vdelan SVG, ikona zavihka pa je v `web/assets/favicon.svg`, zato lokalni pogled ne potrebuje internetnih virov ali dodatnega prenosa velike slike.
