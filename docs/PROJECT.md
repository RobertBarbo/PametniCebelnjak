...
- Lokalni API na asinhronem strežniku porta `80`: `/api/status`, `/api/history`, `/api/wifi`, `/api/sync/reset` in `/measurements.csv`; ElegantOTA uporablja ločen sinhroni portal `http://<device-ip>:8080/update`.
