...
- Highcharts je v `web/vendor/highcharts.js`, projektna ikona v glavi in ikona zavihka pa v `web/assets/favicon.png`, zato lokalni pogled ne potrebuje internetnih virov.
